...
def adain_get_dataset_train(batch_size=BATCH_SIZE,unit_test=False, content_path="jlbaker361/flickr_humans_mini", style_path="jlbaker361/anime_faces_mini",image_dim=512):
...
def adain_get_dataset_test(batch_size=BATCH_SIZE,unit_test=False, content_path="jlbaker361/flickr_humans_mini", style_path="jlbaker361/anime_faces_mini",image_dim=512):
